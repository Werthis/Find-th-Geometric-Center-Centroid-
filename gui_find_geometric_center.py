...
class GuiGeometric():
    ...
    def make_new_widgets(self):
        ...
        button_take_numbers = tk.Button(self.window, text='Add point', font=('arial', 12), command=self.take_values)
        button_take_numbers.pack()

        self.listbox_of_coordinates = tk.Listbox(self.window, height=5, font=('arial', 12))
        ...
        label_print_geometric_center = tk.Label(self.window, textvariable = self.geometric_center_info, font=('arial', 12))
